'''
Progr02_Clase - Elaboragitr un programa tipo clase que tendrá 3 módulos.
...
▪ El segundo módulo deberá calcular y mostrar en pantalla el total de viviendas con teja del municipio y
departamento, el promedio de viviendas de las localidades, la localidad y la cantidad tanto menor como
mayor de viviendas del municipio y departamento indicado. El módulo debe recibir el departamento,
municipio y la lista de tuplas (localidad y cantidad de viviendas con teja).
