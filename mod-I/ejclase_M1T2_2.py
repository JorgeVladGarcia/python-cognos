'''
Nuevos casos Covid comprobados semanal:
• Pedir los datos de cada día de la semana
• Mostrar el total de casos de la semana
• Mostrar el promedio diario de los casos
'''
